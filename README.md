...
```
Таким образом, нужно лишь просуммировать все $a’_i * n^i$ - целое число, и потом поделить на целое число $a'_0$. Т.к. в итоге должно получиться целое число, то целочисленное деление здесь сработает корректно.
